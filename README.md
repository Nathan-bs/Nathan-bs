# 👋 Olá, eu sou o Nathan Batista 🚀

Sou estudante de **Engenharia de Software na UnB (Gama)** e desenvolvedor focado em **Automação de Processos e DevOps**. Atualmente, aplico tecnologia para resolver problemas reais através de Python, TypeScript e arquiteturas modernas.

---

## 🛠️ No que estou trabalhando
- 🏗️ Desenvolvendo um **CRM customizado** focado em gestão comercial e métricas.
- 🤖 Criando fluxos de automação com **n8n, Selenium e Python** para otimização de workflow.
- ☁️ Explorando **Docker e infraestrutura** para ambientes isolados e escaláveis.
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:lunathanbat@gmail.com)

---
*Engenheiro de Software em formação | UnB 2027*
